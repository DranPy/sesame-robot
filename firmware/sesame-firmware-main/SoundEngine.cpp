...
void SoundEngine::play(SoundID id) {
  ...
  switch (id) {
    case SOUND_REST:   play(soundRest,   2); break;
    case SOUND_STAND:  play(soundStand,  3); break;
    case SOUND_WAVE:   play(soundWave,   5); break;
    case SOUND_DANCE:  play(soundDance,  5); break;
    case SOUND_SWIM:   play(soundSwim,   4); break;
    case SOUND_POINT:  play(soundPoint,  2); break;
    case SOUND_PUSHUP: play(soundPushup, 3); break;
    case SOUND_BOW:    play(soundBow,    3); break;
    case SOUND_CUTE:   play(soundCute,   4); break;
    case SOUND_FREAKY: play(soundFreaky, 4); break;
    case SOUND_WORM:   play(soundWorm,   4); break;
    case SOUND_SHAKE:  play(soundShake,  5); break;
    case SOUND_SHRUG:  play(soundShrug,  3); break;
    case SOUND_DEAD:   play(soundDead,   3); break;
    case SOUND_CRAB:   play(soundCrab,   5); break;
  }
}
